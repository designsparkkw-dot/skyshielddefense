...
const cleanPages = ['protect','detect','secure','about','industries','blog','contact','privacy','terms','polyurea','drone-interceptors','polyurea-blast-mitigation','airport-drone-security','marine-coatings','vip-protection'];
